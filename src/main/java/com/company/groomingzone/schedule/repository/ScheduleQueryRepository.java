...
public class ScheduleQueryRepository {
    ...
    // 특정 날짜 범위의 스케줄 조회
//    public List<ScheduleEntity> findSchedulesInDateRange(OffsetDateTime startDate, OffsetDateTime endDate) {
...
//    public List<ScheduleEntity> findFutureSchedulesByBarberShop(Long barberShopId, OffsetDateTime fromDate) {
//        QBarberShopScheduleEntity schedule = QBarberShopScheduleEntity.barberShopScheduleEntity;
//
//        return queryFactory
//                .selectFrom(schedule)
...
//
//    // 여러 바버의 스케줄을 한번에 조회
//    public List<ScheduleEntity> findSchedulesByBarberIds(List<Long> barberIds, OffsetDateTime fromDate) {
//        QBarberShopScheduleEntity schedule = QBarberShopScheduleEntity.barberShopScheduleEntity;
//
//        return queryFactory
//                .selectFrom(schedule)
...
//    public List<ScheduleEntity> findSchedulesInTimeRange(OffsetDateTime baseDate, int startHour, int endHour) {
//        QBarberShopScheduleEntity schedule = QBarberShopScheduleEntity.barberShopScheduleEntity;
//
...
//
//    // 페이징 처리된 스케줄 조회
//    public Page<ScheduleEntity> findSchedulesWithPaging(Long barberShopId, Pageable pageable) {
//        QBarberShopScheduleEntity schedule = QBarberShopScheduleEntity.barberShopScheduleEntity;
//
//        List<ScheduleEntity> schedules = queryFactory
//                .selectFrom(schedule)
...
//
//    // 동적 쿼리 예시
//    public List<ScheduleEntity> findSchedulesByDynamicConditions(
//            Long barberId,
//            Long barberShopId,
