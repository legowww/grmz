...
public class QReservationEntity extends EntityPathBase<ReservationEntity> {
    ...
    private static final long serialVersionUID = 49932977L;
    ...
    public final EnumPath<com.company.groomingzone.reservation.domain.ReservationStatus> reservationStatus = createEnum("reservationStatus", com.company.groomingzone.reservation.domain.ReservationStatus.class);
